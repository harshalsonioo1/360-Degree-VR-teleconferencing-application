...
void CheckTile(Tile *tile, int length, int row, Tile *temp, int &temp_length, int *tileIndex) 
{
	int i;
	int k = 0;
	int width = 0;
...
void ProduceFrame(int target_height, int target_width, int gap_h, int gap_w)  
{
	AVFrame * pDstFrame;
...
//ÿһ֡����һ�� �����ںϲ�tile
void Update_Tile(AVFrame * pDstFrame, AVFrame **Cur, Tile *tile, int length, int width, int height) //width �� height�����������
{
	int nYIndex = 0;
	Tile temp[MAX_TILE];
...
void  CreateDecoder_Real(int tilenumber, char *filepath)  //ʵ�ʺ���
{
