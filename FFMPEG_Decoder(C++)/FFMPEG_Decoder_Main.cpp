...
void CheckTile(Tile **tile, int length, int row,int *temp,int &temp_length,int *tileIndex) 
{
	int i;
	int k = 0;
	int width = 0;
...
void CheckTile_UV(Tile **tile, int length, int row, int *temp, int &temp_length, int *tileIndex) 
{
	int i;
	int k = 0;
	int width = 0;
...
void ProduceFrame(Produce_data *p)  
{
